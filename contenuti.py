...
SCHEDE = [
    ...
    # ---------------------------------------------------------------- 37
    {
        ...
        "specifiche": [
            ...
            ("SINTESI", "12 oscillatori + divisore"),
            ("TASTI", "49, colori invertiti"),
        ],
        "gancio": "I tasti sono al contrario: bianchi e neri scambiati. Bastava guardarlo per capire che non era un piano",
        "sottotitolo": "L'organo portatile che nel '64 apre House of the Rising Sun, e dal '66 comincia a nascere anche in Italia.",
        "la_macchina": "Nel 1962 chi suonava l'organo in un gruppo doveva portarsi dietro un Hammond, pesante, ingombrante, da assicurare al furgone ogni sera. Vox costruisce il Continental apposta per il palco, leggero, con una gamba a X che si ripiega in fretta. Dentro non ci sono le ruote foniche dell'Hammond — dodici oscillatori generano le note più acute, un divisore le porta giù di ottava in ottava. E la tastiera si riconosce da lontano, bianco e nero scambiati, coi tasti naturali neri. A me, quel dispetto ai pianisti di passaggio, è sempre piaciuto.",
        "inventore_nome": "Tom Jennings",
        "inventore": "Tom Jennings comincia nel 1944 a Dartford, in Inghilterra, riparando fisarmoniche in un negozio. Dopo la guerra passa agli strumenti a tastiera e fonda la Jennings Musical Instruments. Il Continental lo presenta nell'agosto 1962, alla fiera del Russell Hotel di Londra: è la risposta di JMI a un mercato di gruppi beat che suonano ogni sera in un locale diverso e non possono portarsi un Hammond.",
        "come_funziona": "Non sono ruote foniche come nell'Hammond: dodici oscillatori generano le note più acute, e un circuito divisore dimezza la frequenza a ogni ottava sotto, tirando fuori onde quadre invece delle sinusoidi Hammond. Il timbro è più tagliente, buca il mix di chitarra e basso. Sei drawbar in stile Hammond regolano i registri. Perché i tasti siano invertiti rispetto al piano, con le note naturali nere, nessuna fonte lo spiega con certezza — è così dal primo giorno di produzione, e da quella tastiera si riconosce un Continental anche a distanza.",
        "richiami": [
            ("FIG. 1", "12 oscillatori + divisore"),
            ("FIG. 2", "6 drawbar stile Hammond"),
            ("FIG. 3", "Tasti a colori invertiti"),
        ],
        "chi_lusata": [
            {"artista": "Alan Price (The Animals)", "nota": "«House of the Rising Sun», 1964, registrata in una sola ripresa il 18 maggio", "ig": None},
            {"artista": "Ray Manzarek (The Doors)", "nota": "Sul primo disco, The Doors (1967); dal 1968 passa al Gibson G-101", "ig": None},
        ],
        "menzioni_extra": [
            {"ig": "voxamplification",
             "riga": "Il marchio è ancora vivo, oggi di proprietà Korg: lo trovate da @voxamplification."},
        ],
        "aneddoto": "Il Continental nasce inglese, a Dartford, ma dal 1966 viene costruito anche in Italia: un accordo fra Jennings e la Thomas Organ Company sposta la produzione per gli Stati Uniti alla EME, joint venture con la fabbrica EKO di Recanati. Alla fine del 1968 apre a Montecassiano uno stabilimento dedicato. Quindi l'organo che Alan Price suona nel '64 su un disco inglese, due anni dopo lo si costruisce anche nelle Marche.",
        "avvertenza": "Le note naturali sono nere, le alterazioni bianche: chi legge la tastiera come un piano sbaglia ogni accordo al primo tentativo.",
        "da_ascoltare": {"brano": "House of the Rising Sun", "artista": "The Animals (Alan Price all'organo)",
                          "anno": "1964",
                          "cosa": "Un accordo tenuto, poi l'arpeggio che sale: l'organo apre il disco e non si ferma più. Registrato in una sola ripresa, il 18 maggio 1964."},
        "foto": {
        ...
        "foto_extra": [
            {"file": "assets/foto/voxcontinental/drawbar.jpg",
             "autore": "Docrobbie", "licenza": "CC BY-SA 4.0", "fonte": "Wikimedia Commons",
             "didascalia": "I sei drawbar in stile Hammond"},
            {"file": "assets/foto/voxcontinental/interno.jpg",
             "autore": "Starlingjon", "licenza": "Pubblico dominio", "fonte": "Wikimedia Commons",
             "didascalia": "Dentro: i dodici oscillatori e i divisori di frequenza"},
        ],
        "fonti": [
            {"titolo": "«Vox Continental» — Wikipedia (EN)",
             "url": "https://en.wikipedia.org/wiki/Vox_Continental", "data": "2026-09-18"},
            {"titolo": "«Vox Continental» — VOX AC30 Archive (storia e cronologia di produzione)",
             "url": "https://www.voxac30.org.uk/vox_continental.html", "data": "2026-09-18"},
            {"titolo": "«Vox Continental Italian Production» — VOX AC30 Archive",
             "url": "https://www.voxac30.org.uk/vox_continental_italian_production.html", "data": "2026-09-18"},
            {"titolo": "«The House of the Rising Sun» — Wikipedia (EN)",
             "url": "https://en.wikipedia.org/wiki/The_House_of_the_Rising_Sun", "data": "2026-09-18"},
            {"titolo": "«Ray Manzarek» — Wikipedia (EN)",
             "url": "https://en.wikipedia.org/wiki/Ray_Manzarek", "data": "2026-09-18"},
        ],
        "hashtags": ["#voxcontinental", "#organo", "#musicaelettronica", "#anni60", "#storiadellamusica"],
        "verificata": True,
    },
    # ---------------------------------------------------------------- 38
    {
        ...
        "anno": "1987",
        "luogo": "Scotts Valley, California",
        "costruttore": "E-mu Systems",
        "specifiche": [
            ("ANNO", "1987"),
            ("COSTRUTTORE", "E-mu Systems"),
            ("CAMPIONAMENTO", "12 bit, 26,04 kHz"),
            ("MEMORIA", "10 s totali, 2,5 s a suono"),
        ],
        "gancio": "Dieci secondi di memoria in tutto, eppure ci hanno costruito sopra l'hip hop dei tardi anni Ottanta",
        "sottotitolo": "Il campionatore-drum machine che suona sporco per un limite tecnico, e quel limite è diventato un suono.",
        "la_macchina": "Prima dell'SP-1200 le drum machine E-mu, tipo l'SP-12, avevano suoni di batteria fissi, incisi in fabbrica. Qui invece campioni quello che vuoi, un rullante da un disco, un fiato, una voce, e lo suoni dai pad. Il problema è la memoria: 10 secondi in tutto, divisi in 4 banchi da 8 suoni, e ogni singolo campione non supera i 2,5 secondi. I produttori hip hop dell'epoca ci lavoravano dentro con quel vincolo, non nonostante quel vincolo.",
        "inventore_nome": "Dave Rossum",
        "inventore": "Dave Rossum, cofondatore di E-mu Systems, firma l'SP-1200 nell'agosto 1987 come evoluzione del suo SP-12 di due anni prima: stesso concetto, ma con la possibilità di campionare i propri suoni invece di usare quelli fissi in ROM. Costava 2.995 dollari. Nel 2015 Rossum riacquista i marchi SP-12 e SP-1200 e li rimette in produzione con la sua nuova azienda, Rossum Electro-Music, fino al 2025.",
        "come_funziona": "Il campionamento è a 12 bit e 26,04 kHz, molto meno degli oltre 44 kHz di un CD: la conversione introduce rumore, e i filtri analogici SSM2044 in uscita colorano ancora il suono. Per stare dentro i 2,5 secondi per campione, i produttori cambiavano il pitch di lettura — accorciando o allungando il suono insieme alla sua intonazione, un trucco da falegname più che da tecnico del suono. Il risultato è quel timbro sporco che oggi si cerca apposta.",
        "richiami": [
            ("FIG. 1", "12 bit, 26,04 kHz"),
            ("FIG. 2", "4 banchi da 8 suoni"),
            ("FIG. 3", "Filtri analogici SSM2044"),
        ],
        "chi_lusata": [
            {"artista": "Marley Marl", "nota": "«The Bridge Is Over» (Boogie Down Productions, 1987): batteria ripitchata sull'SP-1200", "ig": None},
            {"artista": "Pete Rock", "nota": "«L'ho usato per tutta la carriera», tre esemplari comprati, intervista del 2011", "ig": None},
        ],
        "menzioni_extra": [
            {"ig": "rossumelectro",
             "riga": "Oggi il marchio è di nuovo di Dave Rossum in persona: lo trovate da @rossumelectro."},
        ],
        "aneddoto": "Nel settembre 2013, alla radio, Marley Marl racconta come nacque il beat di «The Bridge Is Over»: il nastro coi suoi suoni di batteria si era rovinato, e Ced-Gee li recuperò e li ripitchò sull'SP-1200, una nota più in alto. Pete Rock, in un'intervista del 2011, dice di averne comprati tre e di averlo usato per tutta la carriera — «dopo che la gente ha saputo che me la cavavo con l'SP, hanno cominciato a usarlo tutti». Oggi un SP-1200 funzionante si vende per diverse migliaia di dollari.",
        "avvertenza": "Un campione non supera i 2,5 secondi: oltre quel limite la macchina non registra altro, tagliente e senza avviso.",
        "da_ascoltare": {"brano": "The Bridge Is Over", "artista": "Boogie Down Productions (batteria campionata sull'SP-1200)",
                          "anno": "1987",
                          "cosa": "Il primo colpo di rullante è un campione ripitchato: lo stesso suono, una nota più in alto di come Marley Marl lo aveva registrato in origine."},
        "foto": {
        ...
        "foto_extra": [
            {"file": "assets/foto/sp1200/fronte.jpg",
             "autore": "2xUeL", "licenza": "Pubblico dominio", "fonte": "Wikimedia Commons",
             "didascalia": "I pad e il pannello frontale"},
            {"file": "assets/foto/sp1200/retro.jpg",
             "autore": "2xUeL", "licenza": "Pubblico dominio", "fonte": "Wikimedia Commons",
             "didascalia": "Il pannello posteriore, con le uscite"},
        ],
        "fonti": [
            {"titolo": "«E-mu SP-1200» — Wikipedia (EN)",
             "url": "https://en.wikipedia.org/wiki/E-mu_SP-1200", "data": "2026-09-18"},
            {"titolo": "«Secrets Of The E-Mu SP-1200, With Creator Dave Rossum» — Synthtopia",
             "url": "https://www.synthtopia.com/content/2016/04/14/secrets-of-the-e-mu-sp-1200-with-creator-dave-rossum/", "data": "2026-09-18"},
            {"titolo": "«Marley Marl On The Bridge Wars, LL Cool J And Discovering Sampling» — WUNC/NPR",
             "url": "https://www.wunc.org/npr-music/2013-09-12/marley-marl-on-the-bridge-wars-ll-cool-j-and-discovering-sampling", "data": "2026-09-18"},
            {"titolo": "«Pete Rock Tells All: The Stories Behind His Classic Records» — Complex",
             "url": "https://complex.com/music/2011/06/interview-pete-rock-classics/remember", "data": "2026-09-18"},
            {"titolo": "«The E-mu SP-1200: How one sampler ushered in a revolution» — MusicTech",
             "url": "https://musictech.com/features/opinion-analysis/e-mu-sp-1200/", "data": "2026-09-18"},
        ],
        "hashtags": ["#sp1200", "#emu", "#campionatore", "#hiphop", "#musicaelettronica"],
        "verificata": True,
    },
    # ---------------------------------------------------------------- 39
    {
        ...
        "specifiche": [
            ("ANNO", "1976/77"),
            ("COSTRUTTORE", "Yamaha"),
            ("VOCI", "8, doppio strato"),
            ("PREZZO", "6.900 $"),
        ],
        "gancio": "Pesa 100 chili con la custodia, e Vangelis lo ha chiamato il sintetizzatore più importante della sua carriera",
        "sottotitolo": "Otto voci vere, due strati di suono ciascuna, e un ribbon controller al posto della rotella del pitch.",
        "la_macchina": "Le fonti non sono d'accordo sull'anno esatto, 1976 o 1977, ma sul resto concordano tutte: è il primo synth Yamaha davvero polifonico, otto voci, e ognuna con due strati di suono sovrapponibili — fino a sedici oscillatori insieme. Costava 6.900 dollari, quasi il doppio di un Prophet-5. Pesa intorno ai 100 chili con la custodia rigida e gli accessori, e spostarlo da soli non è pensabile.",
        "inventore_nome": "Yamaha (progettisti non documentati)",
        "inventore": "Il CS-80 nasce per non lasciare che il mercato alto dei synth polifonici vada solo a Moog, Sequential Circuits e Oberheim. Yamaha un pubblico se l'era già garantito: nel 1975 aveva messo in vendita il GX-1, tre manuali, quasi 60.000 dollari, meno di 100 esemplari costruiti, comprato anche da Stevie Wonder e Keith Emerson. Il CS-80 porta la stessa idea a un prezzo più abbordabile, 6.900 dollari. Di chi lo abbia progettato in azienda nessuna fonte fa il nome, nemmeno quelle giapponesi. Qui il synth porta la firma di Yamaha e basta, non quella di un singolo ingegnere.",
        "come_funziona": "Ogni voce ha due oscillatori e due filtri, uno passa-alto e uno passa-basso, con inviluppi propri: otto voci per sedici oscillatori attivi, un numero enorme per un synth analogico del 1976. La vera novità è sopra la tastiera, un ribbon controller a nastro per il pitch bend, e ogni tasto risponde alla pressione in modo indipendente dagli altri — è l'aftertouch polifonico, raro anche oggi.",
        "richiami": [
            ("FIG. 1", "8 voci, 2 strati ciascuna"),
            ("FIG. 2", "Ribbon controller"),
            ("FIG. 3", "Aftertouch polifonico"),
        ],
        "chi_lusata": [
            {"artista": "Vangelis", "nota": "«Chariots of Fire» (1981) e «Blade Runner» (1982): «il sintetizzatore più importante della mia carriera», parole sue", "ig": None},
            {"artista": "Toto (David Paich)", "nota": "Il riff di fiati che apre «Africa» (1982), secondo il racconto diretto di Paich", "ig": None},
            {"artista": "Paul McCartney", "nota": "Gli accordi di «Wonderful Christmastime» (1979), suonati a mano senza sincronizzazione", "ig": None},
        ],
        "menzioni_extra": [
            {"ig": "yamahasynths_official",
             "riga": "Il synth vive ancora nel catalogo Yamaha di oggi, raccontato da @yamahasynths_official."},
        ],
        "aneddoto": "Nel 2023 David Paich ha raccontato come è nato il motivo di fiati che apre «Africa», il pezzo dei Toto del 1982: lo ha scritto e suonato lui, al CS-80, cercando un suono di corno che sembrasse vero senza esserlo. Un'altra fonte attribuisce quella parte a Steve Porcaro, non a Paich — ma la testimonianza più diretta, quella di chi dice di averla suonata, resta la sua.",
        "avvertenza": "Non trasportatelo in verticale con il pannello posteriore verso il basso: parte accordato, non è detto che arrivi così.",
        "da_ascoltare": {"brano": "Africa", "artista": "Toto (CS-80 di David Paich, secondo il suo racconto)",
                          "anno": "1982",
                          "cosa": "L'intro di fiati sintetici che apre il disco: un suono di corno finto, scritto e suonato sul CS-80. Ascoltatelo sapendo che non è mai stato un ottone vero."},
        "foto": {
        ...
        "foto_extra": [
            {"file": "assets/foto/cs80/interno.jpg",
             ...
             "didascalia": "Dentro: la circuiteria analogica"},
        ],
        "fonti": [
            {"titolo": "«Yamaha CS-80» — Wikipedia (EN)",
             "url": "https://en.wikipedia.org/wiki/Yamaha_CS-80", "data": "2026-09-18"},
            {"titolo": "«Yamaha CS80» — recensione d'epoca, Sound on Sound",
             "url": "https://www.soundonsound.com/reviews/yamaha-cs80", "data": "2026-09-18"},
            {"titolo": "«Exploring The Yamaha CS-80» — Reverb Machine",
             "url": "https://reverbmachine.com/blog/exploring-the-yamaha-cs-80/", "data": "2026-09-18"},
            {"titolo": "«Toto's David Paich on the making of Africa» — MusicRadar",
             "url": "https://www.musicradar.com/news/recording-week-2023-totos-david-paich-on-the-making-of-africa", "data": "2026-09-18"},
            {"titolo": "«Vangelis's first Yamaha CS-80 was listed on Reverb for £400k» — MusicTech",
             "url": "https://musictech.com/news/gear/vangelis-yamaha-cs-80-for-sale/", "data": "2026-09-18"},
        ],
        "hashtags": ["#yamahacs80", "#vangelis", "#sintetizzatore", "#musicaelettronica", "#anni70"],
        "verificata": True,
    },
    # ---------------------------------------------------------------- 40
    {
        ...
        "da_ascoltare": {"brano": "Chameleon", "artista": "Herbie Hancock",
                          "anno": "1973",
                          "cosa": "Il basso che apre il pezzo: due oscillatori scordati apposta. Sul synth esatto le fonti non concordano, Odyssey o Minimoog — ascoltatelo comunque, è lo stesso identico basso."},
        "foto": {
        ...
        "foto_extra": [
            {"file": "assets/foto/arpodyssey/due_versioni.jpg",
             ...
             "didascalia": "Mk I e Mk II fianco a fianco, con un Roland JX-3P sopra"},
        ],
        "fonti": [
